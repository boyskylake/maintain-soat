...
function Step1Component(
    ...
    const onSubmit = (data) => {
        ...
        services.API("/api/v1/officer/pageone", requestOptions).then((res) => {
            if (res.rc_code === "1") {
                ...
                console.log('CookiePageOne',CookiePageOne);
                if (CookiePageOne && CookiePageOne.coopid) {
                    console.log("in if");
                    handleUnComplete()
                    // handleNext();
                    // handleUnComplete()
    ...
    useEffect(() => {
        ...
        if (cookies && cookies.pageone && cookies.pageone.coopid) {
                ...
                <div className="grid grid-cols-12 gap-4 row-gap-5 mt-3">
                    ...
                    <div className="intro-y col-span-12 sm:col-span-2">
                        ...
                        <input
                            ...
                            ref={register}
                            value={
                                cookies.pageone && cookies.pageone.receive_date
                            }
                        />
                    </div>
                    {/* เวลานัดหมาย */}
                    ...
                    <div className="intro-y col-span-12 sm:col-span-2">
                        ...
                        <input
                            ...
                            value={
                                cookies.pageone &&
                                cookies.pageone.start_date_tdata
                            }
                        />
                        {/* {errors.dateRevice && (
                                        <span>This field is required</span>
                                            ...
                                            <div className="overflow-y-auto h-64 mt-3">
                                                ...
                                                >
                                                    ...
                                                    <code className="text-xs p-0 rounded-md html pl-5 pt-8 pb-4 -mb-10 -mt-10">
                                                        ...
                                                        class="dropzone
                                                        border-gray-200
                                                        border-dashed"HTMLCloseTag
                                                        HTMLOpenTagdiv
                                                        class="fallback"HTMLCloseTag
                                                        HTMLOpenTaginput
                                                        name="file" type="file"
                                                        multiple/HTMLCloseTag
                                                        HTMLOpenTag/divHTMLCloseTag
                                                        HTMLOpenTagdiv
                                                        class="dz-message"
                                                        data-dz-messageHTMLCloseTag
                                                        HTMLOpenTagdiv
                                                        class="text-lg
                                                        font-medium"HTMLCloseTagDrop
                                                        files here or click to
                                                        upload.HTMLOpenTag/divHTMLCloseTag
                                                        HTMLOpenTagdiv
                                                        class="text-gray-600"HTMLCloseTag
                                                        This is just a demo
                                                        dropzone. Selected files
                                                        are HTMLOpenTagspan
                                                        class="font-medium"HTMLCloseTagnotHTMLOpenTag/spanHTMLCloseTag
                                                        actually uploaded.
                                                        HTMLOpenTag/divHTMLCloseTag
                                                        HTMLOpenTag/divHTMLCloseTag
...
const ErrorSpan = ({ children, className }) => {
    return (
        <span className={`text-red-500 text-xs ${className && className} `}>
            {" "}
            {children && children}
        </span>
    );
