...
const Header = () => {
    ...
    const [feedAccount, setfeedAccount] = useState();

    useEffect(() => {
        async function feedData() {
            service
                .API("/api/v1/officer/Profile", { method: "Get" })
                .then((res) => {
                    setfeedAccount(res);
                });
        }
                ...
                >
                    ...
                    {feedAccount && (
                        <div className="pull-left image">
                            <img
                                src={`/storage/${feedAccount.Profile.avatar}`}
